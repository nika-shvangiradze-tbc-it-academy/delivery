-- Raise customer Excel/bulk import limit from 500 → 700.
-- Safe to re-run: CREATE OR REPLACE of customer_bulk_create_orders.
-- Keep body in sync with 20260920_customer_bulk_create_orders.sql (limit = 700).
